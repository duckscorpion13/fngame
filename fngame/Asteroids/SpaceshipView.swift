...
@objc protocol SpaceshipViewDelegate
{
...
class SpaceshipView: UIView
{
    ...
    weak var delegate: SpaceshipViewDelegate? = nil
    ...
    private struct Constants {
        ...
        static let shipImage = UIImage(named: "car")
        static let shipWithEnginesFiringImage = UIImage(named: "car")
